...
struct GroupQueueInfo                                       // stores information about the group in queue (also used when joined as solo!)
{
    ...
    uint32  GuildId;                                        // guildId for GuildWars
};
...
{
    BG_QUEUE_GUILD_FALSE    = 0,
    BG_QUEUE_GUILD_TRUE     = 1,
    BG_QUEUE_GUILD_BOOL     = 2,
};
...
class BattlegroundQueue
{
    public:
        ...
        void BattlegroundQueueUpdate(uint32 diff, BattlegroundTypeId bgTypeId, BattlegroundBracketId bracket_id, uint8 arenaType = 0, bool isRated = false, uint32 minRating = 0, bool GuildWars = false);
        ...
        void FillPlayersToBG(Battleground* bg, BattlegroundBracketId bracket_id, bool GuildWars = false);
        bool CheckPremadeMatch(BattlegroundBracketId bracket_id, uint32 MinPlayersPerTeam, uint32 MaxPlayersPerTeam, bool GuildWars = false);
        bool CheckNormalMatch(Battleground* bg_template, BattlegroundBracketId bracket_id, uint32 minPlayers, uint32 maxPlayers, bool GuildWars = false);
        bool CheckSkirmishForSameFaction(BattlegroundBracketId bracket_id, uint32 minPlayersPerTeam);
        bool CheckSolo3v3Arena(BattlegroundBracketId bracket_id, bool GuildWars = false);
        ...
        */
        GroupsQueueType m_QueuedGroups[MAX_BATTLEGROUND_BRACKETS][BG_QUEUE_GROUP_TYPES_COUNT][BG_QUEUE_GUILD_BOOL];
