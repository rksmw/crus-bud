...
bool BattlegroundDS::SetupBattleground()
{
    ...
    // buffs
        || !AddObject(BG_DS_OBJECT_BUFF_1, BG_DS_OBJECT_TYPE_BUFF_1, 1321.09f, 762.59f, 3.16f, 2.44f, 0, 0, 0.730314f, -0.683111f, 120)
        || !AddObject(BG_DS_OBJECT_BUFF_2, BG_DS_OBJECT_TYPE_BUFF_2, 1262.57f, 819.44f, 3.16f, 5.56f, 0, 0, 0.700409f, 0.713742f, 120)
    // knockback creatures
