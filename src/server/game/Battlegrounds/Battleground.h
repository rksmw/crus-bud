...
class Battleground
{
    public:
        ...
        void ArenaReadyCheck() const;

        // ////////////////////////////////
        // GuildWars
        // ////////////////////////////////
        bool IsGuildWars();
        uint32 GetGuildId(uint32 teamId) const { return m_guildId[teamId]; }
        void SetGuildId(uint32 guildId, uint32 teamId) { m_guildId[teamId] = guildId; }
    ...
    private:
        ...
        // GuildWars
        // ////////////////////////////////
        uint32 m_guildId[BG_TEAMS_COUNT];
};
#endif
