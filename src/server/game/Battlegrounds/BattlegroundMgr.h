...
class BattlegroundMgr
{
    ...
    public:
        ...
        Battleground* CreateNewBattleground(BattlegroundTypeId bgTypeId, PvPDifficultyEntry const* bracketEntry, uint8 arenaType, bool isRated, uint32 guildIdA = 0, uint32 guildIdH = 0);
