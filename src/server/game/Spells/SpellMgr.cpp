...
void SpellMgr::LoadSpellInfoCustomAttributes()
{
    ...
    if (!result)
        TC_LOG_INFO(LOG_FILTER_SERVER_LOADING, ">> Loaded 0 spell custom attributes from DB. DB table `spell_custom_attr` is empty.");
    else
    {
        uint32 count = 0;
        do
        {
            ...
            if (!spellInfo)
            {
                TC_LOG_ERROR(LOG_FILTER_SQL, "Table `spell_custom_attr` has wrong spell (entry: %u), ignored.", spellId);
                continue;
            }
        ...
        TC_LOG_INFO(LOG_FILTER_SERVER_LOADING, ">> Loaded %u spell custom attributes from DB in %u ms", count, GetMSTimeDiffToNow(oldMSTime2));
    }
    ...
    for (uint32 i = 0; i < GetSpellInfoStoreSize(); ++i)
    {
        ...
        switch (spellInfo->Id)
        {
            ...
            case 70337: // Necrotic Plague (10n) [The Lich King]
            case 73912: // Necrotic Plague (25n) [The Lich King]
            case 73913: // Necrotic Plague (10h) [The Lich King]
            case 73914: // Necrotic Plague (25h) [The Lich King]
            case 70338: // Necrotic Plague [The Lich King]
            case 73785: // Necrotic Plague [The Lich King]
            case 73786: // Necrotic Plague [The Lich King]
            case 73787: // Necrotic Plague [The Lich King]
            case 70372: // Summon Shambling Horror [The Lich King]
            case 69836: // Summon Risen Witch Doctor [The Lich King]
            case 69639: // Risen Witch Doctor Spawn [The Lich King]
            case 70358: // Summon Drudge Ghouls [The Lich King]
            case 49575: // Death Grip (jump - from target to caster)
                spellInfo->AttributesEx2 |= SPELL_ATTR2_CAN_TARGET_NOT_IN_LOS;
                break;
            case 52212: // Death Knight: Death and Decay trigger spell
                spellInfo->AttributesEx6 |= SPELL_ATTR6_CAN_TARGET_INVISIBLE;
                break;
            case 72347: // ID - 72347 Lock Players and Tap Chest
                spellInfo->AttributesCu |= SPELL_ATTR0_CU_NEGATIVE_EFF0;
                break;
            default:
                break;
        ...
        {     
            case SPELLFAMILY_DRUID:
                // Rake
                if (spellInfo->SpellFamilyFlags[0] & 0x1000 && spellInfo->SpellIconID == 494)
...
void SpellMgr::LoadSpellInfoCorrections()
{
    ...
    for (uint32 i = 0; i < GetSpellInfoStoreSize(); ++i)
    {
        ...
        { 
            ...
            case 55361: //Living Bomb
            case 55362: // Living Bomb
                spellInfo->RangeEntry = sSpellRangeStore.LookupEntry(13); // 200yd
                break;
            ...
            case 46968: // ShockWave
                spellInfo->Effects[EFFECT_0].RadiusEntry = sSpellRadiusStore.LookupEntry(EFFECT_RADIUS_10_YARDS); // 10yds
                spellInfo->Effects[EFFECT_1].RadiusEntry = sSpellRadiusStore.LookupEntry(EFFECT_RADIUS_10_YARDS); // 10yds
                break;
            ...
            case 49575: // Deathgrip Speed Hackfix
                spellInfo->Effects[EFFECT_0].MiscValueB = 50;
                break;
            case 34490: // Silencing Shot Wrong Speed
                spellInfo->Speed = 2500.0f;
            ...
            case 53480: // Roar of Sacrifice 
                ...
                spellInfo->Effects[EFFECT_2].ApplyAuraName = SPELL_AURA_SPLIT_DAMAGE_PCT;
            ...
            case 72830: // Achievement Check
                spellInfo->Effects[EFFECT_0].RadiusEntry = sSpellRadiusStore.LookupEntry(EFFECT_RADIUS_50000_YARDS); // 50000yd
                break;
            case 74117: // Lich King Pain and Suffering
                spellInfo->AttributesCu |= SPELL_ATTR0_CU_CONE_BACK;
                break;
            ...
            case 68980: // Harvest Souls
            case 74325: // Harvest Souls
                spellInfo->Effects[EFFECT_0].RadiusEntry = sSpellRadiusStore.LookupEntry(EFFECT_RADIUS_50000_YARDS); // 50000yd
                ...
                spellInfo->AttributesEx4 |= SPELL_ATTR4_IGNORE_RESISTANCES; // No debe ser resistido
                break;
            ...
            // Las spells Place Seaforium Bomb,Place Huge Seaforium Bomb y Place Seaforium Charge, ahora colocara la carga en la posición correcta, evitando que atraviese las texturas
            case 66268: //Seaforium Bomb
            case 66674: //Huge Seaforium Bomb
            case 52410: //Seaforium Charge
                spellInfo->Effects[EFFECT_0].TargetA = SpellImplicitTargetInfo(TARGET_DEST_DEST);
                break;
            case 54994: // Summon Stormforged Pursuer Quest - Sniffing Out the Perpetrator
                spellInfo->DurationEntry = sSpellDurationStore.LookupEntry(21);
                break;
            ...
            case 66551: // Teleport
                spellInfo->RangeEntry = sSpellRangeStore.LookupEntry(13); // 50000yd
                break;
            case 57108: // Flame Shield Target
            ...
            //
            case 53323: //Death Knight runeforging no necesitas estar cerca de la runeforge
            case 53331:
            case 53341:
            case 53343:
            case 53344:
            ...
            case 70164:
                ...
                break;
            case 43680: // Idle (BG Eye icon - afk debuff)
                spellInfo->DurationEntry = sSpellDurationStore.LookupEntry(4); // Set debuff duration to 2 min
                spellInfo->Effects[0].Amplitude = 120000; // Set debuff 43681 (triggered by this) in 2 mins instead 1
                break;
            case 69922: // Temper Quel'Delar
            case 69956: // Return Tempered Quel'Delar
                spellInfo->AttributesEx2 |= SPELL_ATTR2_CAN_TARGET_NOT_IN_LOS;
                break;
            ...
            case 52916: // Honor Among Thieves
                ...
                spellInfo->Effects[EFFECT_0].TargetA = SpellImplicitTargetInfo(TARGET_UNIT_CASTER);
                break;
            case 63163: // Enchanted Bridle (Argent Tournament) - Quest 13663
            ...
            case 71041: // Dungeon Deserter
                spellInfo->SchoolMask = 0; // Removemos el SchoolMask para que no pueda ser dispelleado por Divine Intervention (bug en AuraEffect::HandleAuraModSchoolImmunity $(target->RemoveAura(iter))
                break;
            case 56746: // Punch
                spellInfo->Effects[EFFECT_0].RadiusEntry = sSpellRadiusStore.LookupEntry(EFFECT_RADIUS_5_YARDS); // 5yd
                break;
            case 59565: // Summon Reanimated Abomination
                spellInfo->Effects[EFFECT_0].MiscValue = 31692;
                break;
            ...
            case 59578: // The Art of War (Rank 2) - FOL or Exorcism don't reset swing timer
                ...
                break;
            case 20138: // Improved Devotion Aura (Rank 1)
            case 20139: // Improved Devotion Aura (Rank 2)
            case 20140: // Improved Devotion Aura (Rank 3)
                spellInfo->Effects[EFFECT_1].ApplyAuraName = SPELL_AURA_MOD_HEALING_PCT;
                break;
            case 60541: // Instakill Chosen Zealot
                spellInfo->AttributesEx2 |= SPELL_ATTR2_CAN_TARGET_NOT_IN_LOS;
                break;
            case 60532: // Heart Explosion Effects
                spellInfo->Effects[EFFECT_1].MiscValue = 150; // Knockback ago but not so far, this changes the speed in the xy plane
                break;
            case 24259: // Spell Lock silence
                spellInfo->Speed = 80;
                break;
            case 49177: // Ride Warhead Rocket
                spellInfo->Effects[EFFECT_0].BasePoints = 1;
                break;
            case 70337: // Necrotic Plague (10n) [The Lich King] cant be full resisted
            case 73912: // Necrotic Plague (25n) [The Lich King] cant be full resisted
            case 73913: // Necrotic Plague (10h) [The Lich King] cant be full resisted
            case 73914: // Necrotic Plague (25h) [The Lich King] cant be full resisted
            case 70338: // Necrotic Plague [The Lich King] cant be full resisted
            case 73785: // Necrotic Plague [The Lich King] cant be full resisted
            case 73786: // Necrotic Plague [The Lich King] cant be full resisted
            case 73787: // Necrotic Plague [The Lich King] cant be full resisted
            case 73539: // Spell shadow trap [The Lich King] cant be full resisted
            case 73525: // Spell shadow trap aura [The Lich King] cant be full resisted
                spellInfo->AttributesEx4 |= SPELL_ATTR4_IGNORE_RESISTANCES;
                spellInfo->AttributesEx3 |= SPELL_ATTR3_IGNORE_HIT_RESULT;
                break;
            ...
            case 53257: // Cobra Strikes
                ...
                spellInfo->StackAmount = 0;
                break;
            case 51798: // Quest Complete - There and back again - Brewfest
            case 47134: // Quest Complete - Bark for the Barleybrews - Brewfest
                spellInfo->Effects[EFFECT_0].Effect = 0;
                break;
            case 26157: // PX-238 Winter Wondervolt
            case 26272: // PX-238 Winter Wondervolt
            case 26274: // PX-238 Winter Wondervolt
            case 26273: // PX-238 Winter Wondervolt
            ...
            case 34650: // Shadowfiend Mana Leech
                spellInfo->AttributesEx2 |= SPELL_ATTR2_CAN_TARGET_NOT_IN_LOS;
                break;
            ...
            case 30562: // Legacy of the Mountain King (only usable in Karazhan)
                ...
                break;
            case 61425: // Traveler's Tundra Mammoth (Alliance)
            case 61447: // Traveler's Tundra Mammoth (Horde)
        ...
        {
            //case SPELLFAMILY_HUNTER:
            //    if (spellInfo->Id == 54216) // Masters Call
            //        // Le quito el efecto de carga, para que pueda hacer la spell, cuando la pet esta con efecto ROOT
