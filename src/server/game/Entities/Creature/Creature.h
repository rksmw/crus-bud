...
enum CreatureFlagsExtra
{
    ...
    CREATURE_FLAG_EXTRA_IGNORE_PATHFIND = 0x20000000        // Creature will ignore pathfinding (mmaps)
};
...
#define CREATURE_FLAG_EXTRA_DB_ALLOWED (CREATURE_FLAG_EXTRA_INSTANCE_BIND | CREATURE_FLAG_EXTRA_CIVILIAN | \
    ...
    CREATURE_FLAG_EXTRA_GUARD | CREATURE_FLAG_EXTRA_IGNORE_PATHFIND)
...
class Creature : public Unit, public GridObject<Creature>, public MapObject
{
    public:
        ...
        bool IsIgnorePathfinding() const { return GetCreatureTemplate()->flags_extra & CREATURE_FLAG_EXTRA_IGNORE_PATHFIND; }
        bool CanWalk() const { return GetCreatureTemplate()->InhabitType & INHABIT_GROUND; }
        bool CanSwim() const { return IsPet() || (GetCreatureTemplate()->InhabitType & INHABIT_WATER); }
