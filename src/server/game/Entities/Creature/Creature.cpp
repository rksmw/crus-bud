...
bool Creature::CanCreatureAttack(Unit const* victim, bool /*force*/) const
{
    ...
    // Algunos ajustes en Creature::canCreatureAttack, añadido check para evitar que los boss de Isla de la conquista entren en “EvadeMode” esto permite una batalla más blizzlike
