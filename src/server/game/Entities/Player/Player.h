...
enum CharDeleteMethod
{
    ...
    CHAR_DELETE_SPECIAL = 2                      // Borrar personajes que no esten protegidos
};
...
class Player : public Unit, public GridObject<Player>
{
    ...
    public:
        ...
        InventoryResult CanUseItem(Item* pItem, bool not_loading = true, bool transmo = false) const;
        ...
        void AddSpellCooldown(uint32 spell_id, uint32 itemid, time_t end_time, bool multipleSpells = false);
        ...
        uint32 AddBattlegroundQueueId(BattlegroundQueueTypeId val, bool GuildWars);
        ...
        PartyResult CanUninviteFromGroup(uint64 guidMember = 0) const;
        ...
        void SetCompletedAchievement(AchievementEntry const* entry);
        void DelCompletedAchievement(AchievementEntry const* entry);
        ...
        void SetBlizzLootRate(bool x) { m_BlizzLootRate = x; }
        bool HasBlizzLootRate() const { return m_BlizzLootRate; }
