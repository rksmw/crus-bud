...
class Item : public Object
{
    public:
        ...
        // Transmo Store Battle.cl
        bool IsOnlyTransmo() const { return HasFlag(ITEM_FIELD_FLAGS, ITEM_FLAG_ONLY_TRANSMO); }
        void SetOnlyTransmo() { SetFlag(ITEM_FIELD_FLAGS, ITEM_FLAG_ONLY_TRANSMO); }
