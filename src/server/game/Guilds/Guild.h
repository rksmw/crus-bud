...
// Guild Level System
enum GuildLevelingSystemBonus
{
    GUILD_LEVELING_BONUS_GOLD_GUILD_BANK_RANK_1          = 1,
    GUILD_LEVELING_BONUS_XP_RANK_1                       = 2,
    GUILD_LEVELING_BONUS_FASTER_SPIRIT                   = 3,
    GUILD_LEVELING_BONUS_LOW_COST_REPAIR_RANK_1          = 4,
    GUILD_LEVELING_BONUS_GOLD_GUILD_BANK_RANK_2          = 5,
    GUILD_LEVELING_BONUS_MOUNT_SPEED_RANK_1              = 6,
    GUILD_LEVELING_BONUS_AMOUNT_REPUTATION_RANK_1        = 7,
    GUILD_LEVELING_BONUS_XP_RANK_2                       = 8,
    GUILD_LEVELING_BONUS_LOW_COST_REPAIR_RANK_2          = 9,
    GUILD_LEVELING_BONUS_MOUNT_SPEED_RANK_2              = 10,
    GUILD_LEVELING_BONUS_AMOUNT_REPUTATION_RANK_2        = 11,
    GUILD_LEVELING_BONUS_AMOUNT_HONOR_RANK_1             = 12,
    GUILD_LEVELING_BONUS_AMOUNT_HONOR_RANK_2             = 13,
    GUILD_LEVELING_BONUS_VAULT_MOBILE                    = 14,
    GUILD_LEVELING_BONUS_LOW_COST_TRANSMO_RANK_1         = 15,
    GUILD_LEVELING_BONUS_LOW_COST_TRANSMO_RANK_2         = 16,
    GUILD_LEVELING_BONUS_LOW_COST_TRANSMO_RANK_3         = 17,

    GUILD_LEVELING_BONUS_MAX                             = 18
};

enum GuildLevelingSystemExperienceInstance
{
    EXPERIENCE_INSTANCE_10_NORMAL   = 1000,
    EXPERIENCE_INSTANCE_25_NORMAL   = 1500,
    EXPERIENCE_INSTANCE_10_HEROIC   = 2000,
    EXPERIENCE_INSTANCE_25_HEROIC   = 3000,
};

#define GUILD_LEVELING_MAX_LEVEL 9
...
public:
    ...
    // Guild Level System
    void GuildLevelingSystemLoadLevelInfo();
    bool HasLevelBonusGuildLeveling(uint16 GuildLevelingSystemBonus);
    void GuildLevelingGiveXp(uint32 value);
    void SetLevelGuildLeveling(uint8 level, bool byCommand);
    uint8 GetLevelGuildLevelingSystem() const { return m_guild_system_leveling_level; };
    uint32 GetCurrentXP() const { return m_current_guild_leveling_system_xp; };
    uint32 GetXpForNextLevel() const { return m_xp_next_level; };
...
protected:
    ...
    uint8 m_guild_system_leveling_level;
    uint32 m_current_guild_leveling_system_xp;
    uint32 m_xp_next_level;
