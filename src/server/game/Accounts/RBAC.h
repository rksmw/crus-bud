...
enum RBACPermissions
{
    ...
    // Comandos Arena Espectador
    RBAC_PERM_COMMAND_SPECTATE_VERSION                       = 1000,
    RBAC_PERM_COMMAND_SPECTATE                               = 1001,
    RBAC_PERM_COMMAND_SPECTATE_VIEW                          = 1002,
    RBAC_PERM_COMMAND_SPECTATE_LEAVE                         = 1003,
    RBAC_PERM_COMMAND_SPECTATE_PLAYER                        = 1004,
    RBAC_PERM_COMMAND_SPECTATE_RESET                         = 1005,
    // Comandos XP
    RBAC_PERM_COMMAND_RATE_XP                                = 1006,
    RBAC_PERM_COMMAND_RATE_LOOT                              = 1007,
    // Comandos Zona PVP - Sanctuary
    RBAC_PERM_COMMAND_RELOAD_SANCTUARY                       = 1008,
    RBAC_PERM_COMMAND_RELOAD_FFA                             = 1009,
    // Comanso Info player - Raid info
    RBAC_PERM_COMMAND_PLAYER_INFO                            = 1010,
    RBAC_PERM_COMMAND_RAID_INFO                              = 1011,
    RBAC_PERM_COMMAND_RAID_LIST                              = 1012,

    // .bc
    RBAC_PERM_COMMAND_BC                                     = 1013,
    RBAC_PERM_COMMAND_BC_RESETCD                             = 1014,
    RBAC_PERM_COMMAND_BC_ACCINFO                             = 1015,
    //  1016 - reuse
    // .bc house
    RBAC_PERM_COMMAND_BC_HOUSE_PHASEABLE                     = 1018,
    RBAC_PERM_COMMAND_BC_HOUSE_LIST                          = 1019,
    RBAC_PERM_COMMAND_BC_HOUSE                               = 1020,
    RBAC_PERM_COMMAND_BC_HOUSE_ADD                           = 1021,
    RBAC_PERM_COMMAND_BC_HOUSE_DEL                           = 1022,
    RBAC_PERM_COMMAND_BC_HOUSE_AVAILABLE                     = 1023,
    RBAC_PERM_COMMAND_BC_HOUSE_INFO                          = 1024,
    // .bc event
    RBAC_PERM_COMMAND_BC_EVENT                               = 1025,
    RBAC_PERM_COMMAND_BC_EVENT_ADD                           = 1026,
    RBAC_PERM_COMMAND_BC_EVENT_DEL                           = 1027,
    RBAC_PERM_COMMAND_BC_EVENT_RENAME                        = 1028,
    RBAC_PERM_COMMAND_BC_EVENT_INFO                          = 1029,
    RBAC_PERM_COMMAND_BC_EVENT_APPEAR                        = 1030,
    RBAC_PERM_COMMAND_BC_EVENT_LIST                          = 1031,
    RBAC_PERM_COMMAND_BC_EVENT_VISIBLE                       = 1032,
    RBAC_PERM_COMMAND_BC_EVENT_PHASEMASK                     = 1017,
    RBAC_PERM_COMMAND_BC_EVENT_BUILD                         = 1033,
    // .bc debug
    RBAC_PERM_COMMAND_BC_DEBUG                               = 1034,
    RBAC_PERM_COMMAND_BC_DEBUG_WORLDSTATE                    = 1035,
    RBAC_PERM_COMMAND_BC_DEBUG_ISINRANGE                     = 1036,
    RBAC_PERM_COMMAND_BC_DEBUG_WORLDPACKET                   = 1037,
    // .bc server
    RBAC_PERM_COMMAND_BC_SERVER                              = 1038,
    RBAC_PERM_COMMAND_BC_SERVER_LOCK                         = 1039,
    // .bc instance
    RBAC_PERM_COMMAND_BC_INSTANCE                            = 1040,
    RBAC_PERM_COMMAND_BC_INSTANCE_FREEZE                     = 1041,
    RBAC_PERM_COMMAND_BC_INSTANCE_UNFREEZE                   = 1042,
    // .bc anticheat
    RBAC_PERM_COMMAND_BC_ANTICHEAT                           = 1043,
    RBAC_PERM_COMMAND_BC_ANTICHEAT_HANDLE                    = 1044,
    RBAC_PERM_COMMAND_BC_ANTICHEAT_LISTEN                    = 1045,
    // .bc reload
    RBAC_PERM_COMMAND_BC_RELOAD                              = 1046,
    RBAC_PERM_COMMAND_BC_RELOAD_IPCOUNTRY                    = 1047,
    RBAC_PERM_COMMAND_BC_RELOAD_ACCESS                       = 1048,
    // .gm fixdualspec command.
    RBAC_PERM_COMMAND_GM_FIX_DUAL_SPEC                       = 1049,
    // .quest status <#questId> command
    RBAC_PERM_COMMAND_QUEST_STATUS                           = 1050,

    // .guild leveling
    RBAC_PERM_COMMAND_GUILD_LEVELING                         = 1051,
    RBAC_PERM_COMMAND_GUILD_LEVELING_INFO                    = 1052,
    RBAC_PERM_COMMAND_GUILD_LEVELING_BONUS                   = 1053,
    RBAC_PERM_COMMAND_GUILD_LEVELING_SET                     = 1054,
    RBAC_PERM_COMMAND_GUILD_LEVELING_SET_LEVEL               = 1055,
    RBAC_PERM_COMMAND_GUILD_LEVELING_SET_XP                  = 1056,

    // .phase
    RBAC_PERM_COMMAND_PHASE                                  = 1057,
    RBAC_PERM_COMMAND_PHASE_Join                             = 1058,
    RBAC_PERM_COMMAND_PHASE_GO                               = 1059,
    RBAC_PERM_COMMAND_PHASE_GOTARGET                         = 1060,
    RBAC_PERM_COMMAND_PHASE_GODELETE                         = 1061,
    RBAC_PERM_COMMAND_PHASE_HELP                             = 1062,
    RBAC_PERM_COMMAND_PHASE_DELETE                           = 1063,
    RBAC_PERM_COMMAND_PHASE_KICK                             = 1064,
    RBAC_PERM_COMMAND_PHASE_GET                              = 1065,
    RBAC_PERM_COMMAND_PHASE_COMPELETE                        = 1066,
    RBAC_PERM_COMMAND_PHASE_ADDMEMBER                        = 1067,
    RBAC_PERM_COMMAND_PHASE_ADDNPC                           = 1068,
    RBAC_PERM_COMMAND_PHASE_DELETENPC                        = 1069,
    RBAC_PERM_COMMAND_PHASE_Create                           = 1070,

    // Quest Completer
    RBAC_PERM_COMMAND_QUESTCOMPLETER                         = 1071,
    RBAC_PERM_COMMAND_QUESTCOMPLETER_STATUS                  = 1072,
    RBAC_PERM_COMMAND_QUESTCOMPLETER_ADD                     = 1073,
    RBAC_PERM_COMMAND_QUESTCOMPLETER_DEL                     = 1074,
    RBAC_PERM_COMMAND_QUESTCOMPLETER_COMP                    = 1075,

    // .spy
    RBAC_PERM_COMMAND_SPY                                    = 1076,
    RBAC_PERM_COMMAND_SPY_FOLLOW                             = 1077,
    RBAC_PERM_COMMAND_SPY_GROUPFOLLOW                        = 1078,
    RBAC_PERM_COMMAND_SPY_UNFOLLOW                           = 1079,
    RBAC_PERM_COMMAND_SPY_GROUPUNFOLLOW                      = 1080,
    RBAC_PERM_COMMAND_SPY_CLEAR                              = 1081,
    RBAC_PERM_COMMAND_SPY_STATUS                             = 1082,

    // Comand bradcast
    RBAC_PERM_COMMAND_RELOAD_BROADCAST_TEXT                  = 1083,

    // Quest Completer Reload
    RBAC_PERM_COMMAND_QUESTCOMPLETER_RELOAD                  = 1084,

    // Word Filter
    RBAC_PERM_COMMAND_FILTER                                 = 1085,
    RBAC_PERM_COMMAND_FILTER_MOD                             = 1086,
    RBAC_PERM_COMMAND_FILTER_ADD                             = 1087,
    RBAC_PERM_COMMAND_FILTER_REMOVE                          = 1088,
    RBAC_PERM_COMMAND_FILTER_LIST                            = 1089,
    RBAC_PERM_COMMAND_RELOAD_FILTER                          = 1090,
    RBAC_PERM_COMMAND_RELOAD_LETTER_ANALOG                   = 1091,

    // .json
    RBAC_PERM_COMMAND_JSON                                   = 1101,
    // .json server
    RBAC_PERM_COMMAND_JSON_SERVER                            = 1102,

    // .cementerio
    RBAC_PERM_COMMAND_GRAVEYARD                              = 1201,
