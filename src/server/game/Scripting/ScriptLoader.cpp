...
void AddCustomScripts()
{
    ...
    // custom
    // Battleground
    AddSC_battleground_titles_pvp();
    AddSC_battleground_npc_battlemaster_guildwars();
    AddSC_battleground_arena_spectate();
    AddSC_battleground_solo_queue();
    // Commands
    AddSC_command_json();
    AddSC_command_graveyard();
    AddSC_command_bc();
    AddSC_command_go_move();
    AddSC_command_system_phase();
    AddSC_command_quest_completer();
    // Events
    AddSC_events_pvp_tournament();
    AddSC_events_pvp_gurabashi();
    AddSC_events_pvp_cerdoball();
    AddSC_events_pve_strategy_battle();
    AddSC_events_pve_casino();
    AddSC_events_new_year();
    // GameObject
    AddSC_gameobject_mineral_veins_and_herbs();
    // Item
    AddSC_item_enchant_visual();
    ...
    AddSC_npc_goku();
    AddSC_npc_duel();
    AddSC_npc_change_items();
    // Player
    AddSC_player_store_announcer();
    AddSC_player_raid_info_announce();
    AddSC_player_learn_spells_on_level_up();
    AddSC_player_duel();
    AddSC_player_check_invalid_spells();
    AddSC_player_icon_channel();
    AddSC_player_welcome();
    AddSC_player_boss_announcer();
    AddSC_player_on_login_channel_pvp();
    // Transmog
    AddSC_PWS_Transmogrification();
    AddSC_CS_Transmogrification();
    // other
    AddSC_info_commandscript();
    AddSC_world_query_callback();
    AddSC_world_save_update();
    AddSC_chat_spy();
