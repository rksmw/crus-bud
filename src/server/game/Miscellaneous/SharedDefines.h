...
enum GameObjectArtKit
{
    GO_ART_KIT_NONE                                 = 0,
    GO_ART_KIT_BATTLEFIELD_BANNER_FLAG_HORDE        = 1,
    GO_ART_KIT_BATTLEFIELD_BANNER_FLAG_ALLIANCE     = 2,
    GO_ART_KIT_BATTLEFIELD_BANNER_FLAG_NEUTRAL      = 21,
    GO_ART_KIT_HELLFIRE_NORTH_FLAG_HORDE            = 61,
    GO_ART_KIT_HELLFIRE_NORTH_FLAG_ALLIANCE         = 62,
    GO_ART_KIT_HELLFIRE_NORTH_FLAG_NEUTRAL          = 63,
    GO_ART_KIT_HELLFIRE_SOUTH_FLAG_HORDE            = 64,
    GO_ART_KIT_HELLFIRE_SOUTH_FLAG_ALLIANCE         = 65,
    GO_ART_KIT_HELLFIRE_SOUTH_FLAG_NEUTRAL          = 66,
    GO_ART_KIT_HELLFIRE_WEST_FLAG_HORDE             = 67,
    GO_ART_KIT_HELLFIRE_WEST_FLAG_ALLIANCE          = 68,
    GO_ART_KIT_HELLFIRE_WEST_FLAG_NEUTRAL           = 69,
    GO_ART_KIT_LAVA_SPLASH_PARTICLE                 = 81,
    GO_ART_KIT_INVISIBLE_TRAP                       = 82,
    GO_ART_KIT_AUCHINDOUN_ETHEREAL_RIBBON_TYPE_1    = 101,
    GO_ART_KIT_SUMMERFEST_BONFIRE_ON                = 121,
    GO_ART_KIT_SUMMERFEST_BONFIRE_OFF               = 122,
};
