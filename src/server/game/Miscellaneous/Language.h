...
//  LANG_BG_EY_START_TWO_MINUTES        = 755, - defined above
    ...
    LANG_ARENA_QUEUE_ANNOUNCE_JOIN2     = 11002,
    ...
    LANG_COMMAND_TICKETCOMPLETED        = 11130,
    ...
    LANG_LIST_RAID_WOWREAN              = 11326,
    LANG_LIST_RAID_LOWER_BAR            = 11327,

    // -> Guild Leveling System
    LANG_GUILD_LEVELING_UPPER_BAR        = 11328,
    LANG_GUILD_LEVELING_INFO_LEVEL       = 11329,
    LANG_GUILD_LEVELING_INFO_XP_INFO     = 11330,
    LANG_GUILD_LEVELING_LOWER_BAR        = 11331,
    LANG_GUILD_LEVELING_SERVER_LEVEL_UP  = 11332,

    // -> Quest Completer Command
    LANG_COMMAND_QC                      = 11333, // Syntax: .qc $quest\n\nObtienes informacion sobre el estado de la mision, si esta se encuentra bug el comando te la autocompletara
    LANG_COMMAND_QC_COMPLETE             = 11334, // La mision: %s  ha sido completada con exito!
    LANG_COMMAND_QC_FOUND                = 11335, // La mision: %s se encuentra bug
    LANG_COMMAND_QC_EMPTY                = 11336, // Error: No se encontraron resultados con referencia a la quest %s
    LANG_COMMAND_QC_ADD                  = 11337, // Syntax: .qc add $quest\n\nAñades misiones al sistema para que los players puedan autocompletarlas.
    LANG_COMMAND_QC_ADD_SUCCESS          = 11338, // La Mision: %s fue añadida con exito!
    LANG_COMMAND_QC_ADD_ERROR            = 11339, // Error con la solicitud de añadir la mision %s.
    LANG_COMMAND_QC_DEL                  = 11340, // Syntax: .qc del $quest\n\nEliminas misiones del sistema que ya estan reparadas.
    LANG_COMMAND_QC_DEL_SUCCESS          = 11341, // La Mision: %s fue removida con exito
    LANG_COMMAND_QC_DEL_ERROR            = 11342, // La Mision: %s no se encuentra en el sistema
    LANG_COMMAND_QC_ERROR                = 11343, // Error: Debes ingresar el link de la mision abriendo tu QuestLog y linkeandola(Click+Shif) despues del comando.

    // Word filter
    LANG_WORD_FILTER_FOUND_BAD_WORD_IN_CHAT = 11344,
    LANG_WORD_FILTER_FOUND_BAD_WORD_IN_MAIL = 11345,
