...
class PathGenerator
{
    public:
        ...
        bool CalculatePath(float destX, float destY, float destZ, bool forceDest = false, float startX = 0.0f, float startY = 0.0f, float startZ = 0.0f);
        ...
        uint8 GetPathType() const { return _type; }
    ...
    private:
        ...
        uint8 _type;                       // tells what kind of path this is
