...
enum WorldBoolConfigs
{
    ...
    CONFIG_DALARAN_UNIVERSAL_LANG,
    CONFIG_LOG_COMMANDS_TO_DB,
    CHAR_DELETE_ITEMS,
...
enum WorldFloatConfigs
{
    ...
    CONFIG_SOLO_3V3_ARENAPOINTS_MULTI,
    ...
    CONFIG_ANTICHEAT_MAX_SPEED_DIFF_ALLOWED,
    CONFIG_ARENA_2V2_MULTIPLIER,
    CONFIG_ARENA_3V3_MULTIPLIER,
    CONFIG_ARENA_5V5_MULTIPLIER,
    CONFIG_SOLO_3V3_POINTS,
...
enum WorldIntConfigs
{
    ...
    CONFIG_ARENA_QUEUE_ANNOUNCER_MINRATE2C2,
    CONFIG_ARENA_QUEUE_ANNOUNCER_MINRATE3C3,
    CONFIG_ARENA_QUEUE_ANNOUNCER_MINRATE5C5,
    CONFIG_BATTLEGROUND_QUEUE_ANNOUNCER_JOINEDPLAYERS,
    CONFIG_BATTLEGROUND_QUEUE_ANNOUNCER_PLAYERONLY_JOINEDPLAYERS,
    ...
    CONFIG_WINTERGRASP_TIME_IN_BATTLE,
    CONFIG_WINTERGRASP_TIME_FOR_BATTLE,
    CONFIG_WINTERGRASP_TIME_ON_STARTUP,
...
struct CliCommandHolder
{
    ...
    CliCommandHolder(void* callbackArg, const char *command, Print* zprint, CommandFinished* commandFinished, uint32 accountId = 0)
        : m_callbackArg(callbackArg), m_print(zprint), m_commandFinished(commandFinished), _accountId(accountId)
    {
...
class World
{
    public:
        ...
        bool hasWorldState(uint32 index) const;
        ...
        void SetCountryRestrict(std::string const& country);
        const char* GetCountryRestrict() const;

        // Guild Leveling System
        void LoadGuildLevelingBonus();
        uint8 GetReqGuildLevelForBonus(uint16 GuildLevelingBonus);
    ...
    private:
        ...
        std::string m_contryRestrict;

        // Guild Leveling System
        typedef std::map<uint16, uint8> GuildLevelingBonusMap;
        GuildLevelingBonusMap m_guild_leveling_bonus;
};
