...
enum WorldDatabaseStatements
{
    ...
    */
    ...
    WORLD_SEL_HOUSES,
    WORLD_INS_HOUSE,
    WORLD_UPD_HOUSE_TYPE,
    WORLD_UPD_HOUSE_TEAM,
    WORLD_UPD_HOUSE_AVAILABLE,
    WORLD_UPD_HOUSE_PHASEABLE,
    WORLD_DEL_HOUSE,
    ...
    WORLD_DEL_EVENT,
    WORLD_UPD_EVENT,
    WORLD_SEL_EVENT_CREATURES,
    WORLD_SEL_EVENT_ACCOUNT_CREATURE,
    WORLD_INS_EVENT_CREATURE,
    WORLD_DEL_EVENT_CREATURE,
    WORLD_DEL_EVENT_CREATURES,
    WORLD_SEL_EVENT_GAMEOBJECTS,
    WORLD_SEL_EVENT_ACCOUNT_GAMEOBJECT,
    WORLD_INS_EVENT_GAMEOBJECT,
    WORLD_DEL_EVENT_GAMEOBJECT2,
    WORLD_DEL_EVENT_GAMEOBJECTS,
