...
enum CharacterDatabaseStatements
{
    ...
    */
    ...
    CHAR_SEL_HOUSE_ROOM,
    CHAR_INS_HOUSE_ROOM,
    CHAR_UPD_HOUSE_ROOM_END_TIME,
    CHAR_UPD_HOUSE_ROOM_GUILD,

    CHAR_SEL_ORDERS_COUNT,
    CHAR_SEL_ORDER_EXIST,
    CHAR_SEL_ORDER,
    CHAR_SEL_ORDER_STACK,
    CHAR_UPD_ORDER_STATUS,

    CHAR_INS_RENAME_LOG,
    CHAR_INS_RACECHANGE_LOG,

    CHAR_REP_ITEM_ENCHANT_VISUAL,
    CHAR_DEL_ITEM_ENCHANT_VISUAL,
    CHAR_DEL_ITEM_ENCHANT_VISUAL_NOT_EXIST,
    CHAR_SEL_ITEM_ENCHANT_VISUAL,

    CHAR_SEL_BACKUP_CHARACTER,
    CHAR_INS_BACKUP_ITEM,

    CHAR_SEL_GUILDWARS,
    CHAR_UPD_GUILDWARS_WIN,
    CHAR_UPD_GUILDWARS_LOSE,
    CHAR_INS_GUILDWARS,

    // Guild Leveling System
    CHAR_SEL_GUILD_LEVELING_BONUS,
    CHAR_SEL_GUILD_LEVELING_LEVEL_INFO,
    CHAR_SEL_GUILD_LEVELING_XP_FOR_NEXT_LEVEL,
    CHAR_UPD_GUILD_LEVELING_LEVEL,
    CHAR_UPD_GUILD_LEVELING_XP,
