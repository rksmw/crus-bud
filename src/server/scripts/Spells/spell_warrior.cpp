        ...
        class spell_warr_deep_wounds_SpellScript : public SpellScript
        {
            ...
            void HandleDummy(SpellEffIndex /*effIndex*/)
            {
                ...
                if (Unit* target = GetHitUnit())
                {
                    ...
                    SpellInfo const* spellInfo = sSpellMgr->GetSpellInfo(SPELL_WARRIOR_DEEP_WOUNDS_PERIODIC);
        ...
        class spell_warr_execute_SpellScript : public SpellScript
        {
            ...
            void HandleDummy(SpellEffIndex effIndex)
            {
                ...
                if (Unit* target = GetHitUnit())
                {
                    ...
                    int32 bp = GetEffectValue() + int32(rageUsed * spellInfo->Effects[effIndex].DamageMultiplier + caster->GetTotalAttackPowerValue(BASE_ATTACK) * 0.300f); // (Using AT formula)
