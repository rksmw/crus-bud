        ...
        bool OnTrigger(Player* player, AreaTriggerEntry const* trigger) OVERRIDE
        {
            ...
            switch (trigger->id)
            {
                ...
                case 5334:
                    ...
                    break;
                case 5340:
                    if(player->GetQuestStatus(11898) == QUEST_STATUS_INCOMPLETE)
                        pPosition = WorldLocation(571, 3743.82f, 3571.77f, 341.67f, 0.0f);
                    else
...
{
public:
    AreaTrigger_at_mistwhisper_treasure() : AreaTriggerScript("at_mistwhisper_treasure") { }
