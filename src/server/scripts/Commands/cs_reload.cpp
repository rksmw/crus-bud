...
public:
    ...
    ChatCommand* GetCommands() const
    {
        ...
        static ChatCommand reloadCommandTable[] =
        {
            ...
            { "filter",                        RBAC_PERM_COMMAND_RELOAD_FILTER,                           true,  &HandleReloadFilterCommand,                     "", NULL },
            ...
            { "letter_analog",                 RBAC_PERM_COMMAND_RELOAD_LETTER_ANALOG,                    true,  &HandleReloadLetterAnalogCommand,               "", NULL },
    ...
    static bool HandleReloadAllCommand(ChatHandler* handler, const char* /*args*/)
    {
        ...
        HandleReloadFilterCommand(handler, "");
    ...
    {
        TC_LOG_INFO(LOG_FILTER_GENERAL, "Re-Loading Broadcast texts...");
    ...
    static bool HandleReloadFilterCommand(ChatHandler* handler, const char* /*args*/)
    {
        TC_LOG_INFO(LOG_FILTER_GENERAL, "Re-Loading Censure Words...");
        sWordFilterMgr->LoadBadWords();
        handler->SendGlobalGMSysMessage("DB table `custom_censure_word` reloaded.");
        return true;
    }
    ...
    { // latched onto HandleReloadSkillExtraItemTemplateCommand as it's part of that table group (and i don't want to chance all the command IDs)
        TC_LOG_INFO(LOG_FILTER_GENERAL, "Re-Loading Skill Perfection Data Table...");
    ...
    {
        TC_LOG_INFO(LOG_FILTER_GENERAL, "Re-Loading Letter Analogs...");
    ...
    static bool HandleReloadCustomFFACommand(ChatHandler* handler, const char* /*args*/)
    {
        TC_LOG_INFO(LOG_FILTER_GENERAL, "Re-Loading custom_pvp_zones table...");
        sObjectMgr->LoadCustomFFA();
        handler->SendGlobalGMSysMessage("DB table `custom_pvp_zones` reloaded.");
        return true;
    }

    static bool HandleReloadCustomSanctuaryCommand(ChatHandler* handler, const char* /*args*/)
    {
        TC_LOG_INFO(LOG_FILTER_GENERAL, "Re-Loading custom sanctuary table...");
        sObjectMgr->LoadCustomSanctuary();
        handler->SendGlobalGMSysMessage("DB table `custom_sanctuary` reloaded.");
        return true;
    }
};
