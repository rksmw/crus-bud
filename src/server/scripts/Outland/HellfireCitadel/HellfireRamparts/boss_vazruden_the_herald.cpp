                ...
                default: // adds do the job now
                    if (check <= diff)
                    {
                        ...
                        else if (!lootSpawned)
                        {
                            ...
                            if (GameObject* go = me->SummonGameObject(DUNGEON_MODE(GO_FEL_IRON_CHEST_NORMAL, GO_FEL_IRON_CHECT_HEROIC), VazrudenMiddle[0], VazrudenMiddle[1], VazrudenMiddle[2], 0, 0, 0, 0, 0, 0))
