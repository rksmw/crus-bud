    ...
    public:
        ...
        bool OnGossipHello(Player* player, Creature* creature) OVERRIDE
        {
            ...
            if (sTransmogrification->EnableTransmogInfo)
                player->ADD_GOSSIP_ITEM(GOSSIP_ICON_MONEY_BAG, "|TInterface/ICONS/INV_Misc_Book_11:30:30:-18:0|tEnterate de como funciona el transmogrificador!", EQUIPMENT_SLOT_END + 9, 0);
            ...
            if (sTransmogrification->EnableSets)
                player->ADD_GOSSIP_ITEM(GOSSIP_ICON_MONEY_BAG, "|TInterface/RAIDFRAME/UI-RAIDFRAME-MAINASSIST:30:30:-18:0|tAdministrador de sets", EQUIPMENT_SLOT_END + 4, 0);
#endif
            player->ADD_GOSSIP_ITEM_EXTENDED(GOSSIP_ICON_MONEY_BAG, "|TInterface/ICONS/INV_Enchant_Disenchant:30:30:-18:0|tRemover todas las transmogrificaciones", EQUIPMENT_SLOT_END + 2, 0, "Seguro que deseas remover todas las tranfiguraciones de tus objetos equipados?", 0, false);
            player->ADD_GOSSIP_ITEM(GOSSIP_ICON_MONEY_BAG, "|TInterface/PaperDollInfoFrame/UI-GearManager-Undo:30:30:-18:0|tActualizar menu", EQUIPMENT_SLOT_END + 1, 0);
            ...
            switch (sender)
            {
                ...
                case EQUIPMENT_SLOT_END + 4: // Presets menu
                {
                    ...
                    if (sTransmogrification->EnableSetInfo)
                        player->ADD_GOSSIP_ITEM(GOSSIP_ICON_MONEY_BAG, "|TInterface/ICONS/INV_Misc_Book_11:30:30:-18:0|tenterate de como funciona el administrador de sets", EQUIPMENT_SLOT_END + 10, 0);
                    ...
                    if (!player->presetMap.empty())
                    {
                        ...
                        player->ADD_GOSSIP_ITEM(GOSSIP_ICON_MONEY_BAG, "|TInterface/GuildBankFrame/UI-GuildBankFrame-NewTab:30:30:-18:0|tGuardar Set", EQUIPMENT_SLOT_END + 8, 0);
                    player->ADD_GOSSIP_ITEM(GOSSIP_ICON_MONEY_BAG, "|TInterface/ICONS/Ability_Spy:30:30:-18:0|tAtras..", EQUIPMENT_SLOT_END + 1, 0);
                    player->SEND_GOSSIP_MENU(DEFAULT_GOSSIP_MESSAGE, creature->GetGUID());
                } break;
