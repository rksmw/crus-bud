...
{
    TC_LOG_DEBUG(LOG_FILTER_TRANSMOGRIFIER, "Transmogrification::PresetTransmog");
...
{
    TC_LOG_DEBUG(LOG_FILTER_TRANSMOGRIFIER, "Transmogrification::LoadPlayerSets");
    ...
    do
    {
        ...
        while (SetData.good())
        {
            ...
            if (slot >= EQUIPMENT_SLOT_END)
            {
                TC_LOG_ERROR(LOG_FILTER_TRANSMOGRIFIER, "Item entry (FakeEntry: %u, playerGUID: %u, slot: %u, presetId: %u) has invalid slot, ignoring.", entry, player->GetGUIDLow(), uint32(slot), uint32(PresetID));
                continue;
            }
            if (sObjectMgr->GetItemTemplate(entry))
            {
                ...
                TC_LOG_ERROR(LOG_FILTER_TRANSMOGRIFIER, "Item entry (FakeEntry: %u, playerGUID: %u, slot: %u, presetId: %u) does not exist, ignoring.", entry, player->GetGUIDLow(), uint32(slot), uint32(PresetID));
        }
...
{
    TC_LOG_DEBUG(LOG_FILTER_TRANSMOGRIFIER, "Transmogrification::GetSlotName");
...
{
    TC_LOG_DEBUG(LOG_FILTER_TRANSMOGRIFIER, "Transmogrification::GetItemIcon");
...
{
    TC_LOG_DEBUG(LOG_FILTER_TRANSMOGRIFIER, "Transmogrification::GetSlotIcon");
...
{
    TC_LOG_DEBUG(LOG_FILTER_TRANSMOGRIFIER, "Transmogrification::GetItemLink");
...
{
    TC_LOG_DEBUG(LOG_FILTER_TRANSMOGRIFIER, "Transmogrification::GetFakeEntry");
...
{
    TC_LOG_DEBUG(LOG_FILTER_TRANSMOGRIFIER, "Transmogrification::UpdateItem");
...
{
    TC_LOG_DEBUG(LOG_FILTER_TRANSMOGRIFIER, "Transmogrification::DeleteFakeEntry");
...
{
    TC_LOG_DEBUG(LOG_FILTER_TRANSMOGRIFIER, "Transmogrification::SetFakeEntry");
...
{
    TC_LOG_DEBUG(LOG_FILTER_TRANSMOGRIFIER, "Transmogrification::Transmogrify");

    // slot of the transmogrified item
    if (slot >= EQUIPMENT_SLOT_END)
    {
        TC_LOG_DEBUG(LOG_FILTER_TRANSMOGRIFIER, "Transmogrification::Transmogrify - Player (GUID: %u, name: %s) tried to transmogrify an item (lowguid: %u) with a wrong slot (%u) when transmogrifying items.", player->GetGUIDLow(), player->GetName().c_str(), GUID_LOPART(itemGUID), slot);
    ...
    if (itemGUID)
    {
        ...
        {
            TC_LOG_DEBUG(LOG_FILTER_TRANSMOGRIFIER, "Transmogrification::Transmogrify - Player (GUID: %u, name: %s) tried to transmogrify with an invalid item (lowguid: %u).", player->GetGUIDLow(), player->GetName().c_str(), GUID_LOPART(itemGUID));            
    ...
    {
        TC_LOG_DEBUG(LOG_FILTER_TRANSMOGRIFIER, "Transmogrification::Transmogrify - Player (GUID: %u, name: %s) tried to transmogrify an invalid item in a valid slot (slot: %u).", player->GetGUIDLow(), player->GetName().c_str(), slot);
    ...
    else
    {
        ...
        {
            TC_LOG_DEBUG(LOG_FILTER_TRANSMOGRIFIER, "Transmogrification::Transmogrify - Player (GUID: %u, name: %s) failed CanTransmogrifyItemWithItem (%u with %u).", player->GetGUIDLow(), player->GetName().c_str(), itemTransmogrified->GetEntry(), itemTransmogrifier->GetEntry());
        ...
        if (!no_cost)
        {
            ...
            {
                if (cost < 0)
                    TC_LOG_DEBUG(LOG_FILTER_TRANSMOGRIFIER, "Transmogrification::Transmogrify - Player (GUID: %u, name: %s) transmogrification invalid cost (non negative, amount %i). Transmogrified %u with %u", player->GetGUIDLow(), player->GetName().c_str(), -cost, itemTransmogrified->GetEntry(), itemTransmogrifier->GetEntry());
                else
                {
...
{
    TC_LOG_DEBUG(LOG_FILTER_TRANSMOGRIFIER, "Transmogrification::CanTransmogrifyItemWithItem");
...
{
    TC_LOG_DEBUG(LOG_FILTER_TRANSMOGRIFIER, "Transmogrification::SuitableForTransmogrification");
...
{
    TC_LOG_DEBUG(LOG_FILTER_TRANSMOGRIFIER, "Transmogrification::GetSpecialPrice");
...
{
    TC_LOG_DEBUG(LOG_FILTER_TRANSMOGRIFIER, "Transmogrification::IsRangedWeapon");
...
{
    TC_LOG_DEBUG(LOG_FILTER_TRANSMOGRIFIER, "Transmogrification::IsAllowed");
...
{
    TC_LOG_DEBUG(LOG_FILTER_TRANSMOGRIFIER, "Transmogrification::IsNotAllowed");
...
{
    TC_LOG_DEBUG(LOG_FILTER_TRANSMOGRIFIER, "Transmogrification::IsAllowedQuality");
...
{
    TC_LOG_DEBUG(LOG_FILTER_TRANSMOGRIFIER, "Transmogrification::LoadConfig");
    ...
    {
        TC_LOG_INFO(LOG_FILTER_TRANSMOGRIFIER, "Transmogrification.TokenEntry (%u) does not exist. Using default (%u).", TokenEntry, 49426);
        TokenEntry = 49426;
    }
}
