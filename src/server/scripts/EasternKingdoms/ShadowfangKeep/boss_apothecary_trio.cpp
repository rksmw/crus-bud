...
public:
    ...
    class spell_trio_irresistible_cologne_AuraScript : public AuraScript
    {
        ...
        {
            if (!sSpellMgr->GetSpellInfo(SPELL_COLOGNE_SPILL))
                return false;
            if (!sSpellMgr->GetSpellInfo(SPELL_COLOGNE_SPILL_DMG))
                return false;
            return true;
        }
...
public:
    ...
    class spell_trio_alluring_perfume_AuraScript : public AuraScript
    {
        ...
        {
            if (!sSpellMgr->GetSpellInfo(SPELL_PERFUME_SPILL))
                return false;
            if (!sSpellMgr->GetSpellInfo(SPELL_PERFUME_SPILL_DMG))
                return false;
            return true;
        }
