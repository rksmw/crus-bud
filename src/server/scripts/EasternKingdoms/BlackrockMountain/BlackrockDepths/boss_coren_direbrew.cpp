...
public:
    ...
    struct npc_coren_direbrewAI : public ScriptedAI
    {
        ...
        void EnterCombat(Unit* /*who*/) OVERRIDE
        {
            ...
            if (Creature* creature = me->FindNearestCreature(NPC_DIREBREW_MINION, 1.0f))
                creature->setFaction(FACTION_HOSTILE);
        }
...
public:
    ...
    struct npc_brewmaidenAI : public ScriptedAI
    {
        ...
        void Reset() OVERRIDE
        {
            _brewTimer      = 2 * IN_MILLISECONDS;
            _barrelTimer    = 5 * IN_MILLISECONDS;
            _chuckMugTimer  = 10 * IN_MILLISECONDS;
        }
        ...
        void UpdateAI(uint32 diff) OVERRIDE
        {
            ...
            if (_chuckMugTimer <= diff)
            {
                ...
                _chuckMugTimer = 15 * IN_MILLISECONDS;
            }
            else
                _chuckMugTimer -= diff;
