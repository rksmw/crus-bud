...
public:
    ...
    struct boss_scarlet_commander_mograineAI : public ScriptedAI
    {
        ...
        void Reset() OVERRIDE
        {
            ...
            if (instance)
                if (me->IsAlive())
                    instance->SetData(DATA_MOGRAINE_AND_WHITE_EVENT, NOT_STARTED);
        ...
        void JustReachedHome() OVERRIDE
        {
            if (instance)
            {
                if (instance->GetData(DATA_MOGRAINE_AND_WHITE_EVENT) != NOT_STARTED)
                    instance->SetData(DATA_MOGRAINE_AND_WHITE_EVENT, FAIL);
            }
        }
        ...
        void SpellHit(Unit* /*who*/, const SpellInfo* spell) OVERRIDE
        {
            ...
            if (spell->Id == SPELL_SCARLETRESURRECTION)
            {
                ...
                if (instance)
                    instance->SetData(DATA_MOGRAINE_AND_WHITE_EVENT, SPECIAL);
            }
        }
        ...
        void UpdateAI(uint32 diff) OVERRIDE
        {
            ...
            if (_bHasDied && !_bHeal && instance && instance->GetData(DATA_MOGRAINE_AND_WHITE_EVENT) == SPECIAL)
            {
...
public:
    ...
    struct boss_high_inquisitor_whitemaneAI : public ScriptedAI
    {
        ...
        {
            if (instance && instance->GetData(DATA_MOGRAINE_AND_WHITE_EVENT) == NOT_STARTED)
                return;
