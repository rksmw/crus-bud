...
class RisenDrakkariBatRider : public CreatureScript
{
public:
    RisenDrakkariBatRider() : CreatureScript("RisenDrakkariBatRider") { }

    struct RisenDrakkariBatRiderAI : public ScriptedAI
    {
        RisenDrakkariBatRiderAI(Creature* creature) : ScriptedAI(creature)  { }
    ...
    {
        return new RisenDrakkariBatRiderAI(creature);
    }
};
