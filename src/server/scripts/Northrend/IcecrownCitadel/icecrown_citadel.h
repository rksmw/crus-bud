...
enum DataTypes
{
    ...
    DATA_SINDRAGOSA_DOOR            = 44,
    DATA_SINDRAGOSA_ICE_WALL        = 45,
    DATA_SAURFANG_HORDE_SELLER      = 46,
    DATA_SAURFANG_HORDE_SMITH       = 47,
    DATA_SAURFANG_ALLIANCE_SELLER   = 48,
    DATA_SAURFANG_ALLIANCE_SMITH    = 49,
    DATA_SPAWN_YMIRJAR              = 50,
    DATA_FROSTWING_DOOR             = 51,
    DATA_BLOODWING_DOOR             = 52,
    DATA_CRIMSON_HALL_DOOR          = 53,
    DATA_FIRST_SQUAD_STATE          = 54,
    DATA_SECOND_SQUAD_STATE         = 55,
    DATA_SPIRE_FROSTWYRM_STATE      = 56
};
...
enum CreaturesIds
{
    ...
    NPC_SKYBREAKER_SORCERERS                    = 37026,
    ...
    NPC_SAURFANG_HORDE_SMITH                    = 37936,
    NPC_SAURFANG_HORDE_SELLER                   = 37935,
    NPC_SAURFANG_ALLIANCE_SELLER                = 37904,
    NPC_SAURFANG_ALLIANCE_SMITH                 = 37903,
