    ...
    public:
        ...
        struct instance_icecrown_citadel_InstanceMapScript : public InstanceScript
        {
            ...
            void OnCreatureCreate(Creature* creature) OVERRIDE
            {
                ...
                switch (creature->GetEntry())
                {
                    ...
                    case NPC_SE_MURADIN_BRONZEBEARD:
                        // We need to define right event npc (2 spawns in instance)
                        if (creature->GetPositionZ() < 500.0f)
                    ...
                    case NPC_WICKED_SPIRIT:
                        ...
                        creature->SetSpeed(MOVE_RUN, 0.5f, true);
                        break;
                    ...
                    case NPC_FLESH_EATING_INSECT:
                        if (creature->GetDBTableGUIDLow() == 201399)
                            InsectsGuid[0] = creature->GetGUID();
                        if (creature->GetDBTableGUIDLow() == 201611)
            ...
            void OnGameObjectCreate(GameObject* go) OVERRIDE
            {
                switch (go->GetEntry())
                {
					...
					case GO_SPIRIT_ALARM_4:
						go->m_invisibility.DelFlag(INVISIBILITY_TRAP);
						go->m_invisibility.SetValue(INVISIBILITY_TRAP, 0);
						go->m_stealth.DelFlag(STEALTH_TRAP);
						go->m_stealth.SetValue(STEALTH_TRAP, 0);
						break;
                    ...
                    case GO_LAVAMAN_PILLARS_UNCHAINED:
                        ...
                        break;
                    case GO_SINDRAGOSA_ENTRANCE_DOOR:
                        SindragosaDoor = go->GetGUID();
                        break;
                    case GO_ICE_WALL:
                        SindragosaIceWall = go->GetGUID();
                        break;
            ...
            uint32 GetData(uint32 type) const OVERRIDE
            {
                switch (type)
                {
                    ...
                    case DATA_FIRST_SQUAD_STATE:
                        return frostwyrmStates[0];
                    case DATA_SECOND_SQUAD_STATE:
                        return frostwyrmStates[1];
                    case DATA_SPIRE_FROSTWYRM_STATE:
                        return frostwyrmStates[2];
            ...
            uint64 GetData64(uint32 type) const OVERRIDE
            {
                switch (type)
                {
                    ...
                    case DATA_SINDRAGOSA_DOOR:
                        return SindragosaDoor;
                    case DATA_SINDRAGOSA_ICE_WALL:
                        return SindragosaIceWall;
            ...
            void SetData(uint32 type, uint32 data) OVERRIDE
            {
                switch (type)
                {
                    ...
                    case DATA_UPPERSPIRE_TELE_ACT:
                        ...
                        break;
                    case DATA_FIRST_SQUAD_STATE:
                        frostwyrmStates[0] = data;
                        break;
                    case DATA_SECOND_SQUAD_STATE:
                        frostwyrmStates[1] = data;
                        break;
                    case DATA_SPIRE_FROSTWYRM_STATE:
                        frostwyrmStates[2] = data;
                        if (data == DONE)
                            SaveToDB();
                        break;
                    case DATA_INSECT_SWARM_EVENT:
                        ...
                        switch (data)
                        {
                            case NOT_STARTED:
                                ...
                                for (uint64 insects : InsectsGuid)
                                {
            ...
            void ReadSaveDataMore(std::istringstream& data)
            {
                ...
                data >> temp;
                frostwyrmStates[0] = temp;

                data >> temp;
                frostwyrmStates[1] = temp;

                data >> temp;
                frostwyrmStates[2] = temp;
        ...
        protected:
            ...
            uint64 PutricideGateGUID;
            uint64 PutricideTrapGUID;
            ...
            uint64 SindragosaDoor;      // SindragosaDoor
            uint64 SindragosaIceWall;   // SindragosaIceWall
            uint64 SindragosasWardGUID;
            uint64 OozeValveGUID;
            uint64 GasValveGUID;
            uint64 InsectsGuid[2];
