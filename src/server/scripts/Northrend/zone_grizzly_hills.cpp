...
enum eRedRocket
{
    SPELL_ALLIANCE_BOAT_TO_TORPEDO   = 49257,
    SPELL_HORDE_BOAT_TO_TORPEDO      = 49372,
...
public:
    ...
    struct npc_rocket_propelled_warheadAI : public VehicleAI
    {
        ...
        void PassengerBoarded(Unit* /*player*/, int8 seatId, bool apply) OVERRIDE
        {
            ...
            {
                me->RemoveFlag(UNIT_FIELD_FLAGS_2, UNIT_FLAG2_FORCE_MOVEMENT);
        ...
        {
            if (spell->Id != SPELL_ALLIANCE_BOAT_TO_TORPEDO && spell->Id != SPELL_HORDE_BOAT_TO_TORPEDO)
                return;

            if (Unit* passenger = me->GetVehicleKit()->GetPassenger(0))
            {
                passenger->ExitVehicle();
                passenger->CastSpell(passenger,SPELL_TORPEDO_EXPLOSION,true);
                passenger->JumpTo(0.0f, 40.0f, false);
            }
        }
