...
enum Spells
{
    ...
    // Spells para las estalactitas de la cueva
...
class mob_icicle_cave: public CreatureScript
{
public:
    mob_icicle_cave(): CreatureScript("mob_icicle_cave"){}

    CreatureAI* GetAI(Creature* creature) const OVERRIDE
    {
        return new mob_icicle_caveAI(creature);
    }

    struct mob_icicle_caveAI: public ScriptedAI
    {
        mob_icicle_caveAI(Creature *c): ScriptedAI(c)
        {
