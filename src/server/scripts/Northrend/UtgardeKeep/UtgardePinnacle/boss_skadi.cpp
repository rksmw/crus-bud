        ...
        void SpellHit(Unit* /*caster*/, const SpellInfo* spell) OVERRIDE
        {
            if (spell->Id == SPELL_HARPOON_DAMAGE)
            {
                ...
                if (m_uiSpellHitCount >= 3)
                {
                    ...
                    me->SetHealth(me->GetMaxHealth()); // Hay una mejor manera de hacer esto, lo se, pero como todo el guion del jefe necesita ser reescrito esto no voy a hacer dano.
                }
            }
        }
