...
int Master::Run()
{
    ...
    TC_LOG_INFO(LOG_FILTER_WORLDSERVER, "| ##__  ##            | ##    | ##    | ##          ");      
    TC_LOG_INFO(LOG_FILTER_WORLDSERVER, "| ##  \\ ##  /######  /###### /######  | ##  /###### ");      
    TC_LOG_INFO(LOG_FILTER_WORLDSERVER, "| #######  |____  ##|_  ##_/|_  ##_/  | ## /##__  ##");      
    TC_LOG_INFO(LOG_FILTER_WORLDSERVER, "| ##__  ##  /#######  | ##    | ##    | ##| ########");      
    TC_LOG_INFO(LOG_FILTER_WORLDSERVER, "| ##  \\ ## /##__  ##  | ## /##| ## /##| ##| ##_____/");      
    TC_LOG_INFO(LOG_FILTER_WORLDSERVER, "| #######/|  #######  |  ####/|  ####/| ##|  #######");      
    TC_LOG_INFO(LOG_FILTER_WORLDSERVER, "|_______/  \\_______/   \\___/   \\___/  |__/ \\_______/"); 
    TC_LOG_INFO(LOG_FILTER_WORLDSERVER, "  /######                                       /###### ");  
    TC_LOG_INFO(LOG_FILTER_WORLDSERVER, " /##__  ##                                     /##__  ## "); 																												  
    TC_LOG_INFO(LOG_FILTER_WORLDSERVER, "| ##  \\__/  /######   /######   /######       |__/  \\ ## "); 																												  
    TC_LOG_INFO(LOG_FILTER_WORLDSERVER, "| ##       /##__  ## /##__  ## /##__  ##         /#####/ "); 																												  
    TC_LOG_INFO(LOG_FILTER_WORLDSERVER, "| ##      | ##  \\ ##| ##  \\__/| ########        |___  ## "); 																												  
    TC_LOG_INFO(LOG_FILTER_WORLDSERVER, "| ##    ##| ##  | ##| ##      | ##_____/       /##  \\ ## "); 																												  
    TC_LOG_INFO(LOG_FILTER_WORLDSERVER, "|  ######/|  ######/| ##      |  #######      |  ######/ "); 																												  
    TC_LOG_INFO(LOG_FILTER_WORLDSERVER, " \\______/  \\______/ |__/       \\_______/       \\______/ ");  
    TC_LOG_INFO(LOG_FILTER_WORLDSERVER, "                                     http://battle.cl/");
