...
int ns1__executeCommand(soap* soap, char* command, char** result)
{
    ...
    if (AccountMgr::IsPlayerAccount(accountId))
    {
    ...
    // commands are executed in the world thread. We have to wait for them to be completed
    {
        ...
        CliCommandHolder* cmd = new CliCommandHolder(&connection, command, &SOAPCommand::print, &SOAPCommand::commandFinished, accountId);
