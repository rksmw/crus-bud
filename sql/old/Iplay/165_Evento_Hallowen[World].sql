...
DELETE FROM `gameobject_queststarter` WHERE `id`=186267;
...
DELETE FROM gameobject_queststarter WHERE quest IN (12345, 12377);
INSERT INTO gameobject_queststarter VALUES
(190035, 12345),
(190079, 12377);
DELETE FROM gameobject_questender WHERE quest IN (12345, 12377);
...
(100, 'Las cenizas del hombre de mimbre irradian poder magico.');
...
(19, 0, 11439, 0, 1, 23, 0, 131,        0,0,0, 0, 0, '', NULL),
(19, 0, 11440, 0, 2, 23, 0, 3576,       0,0,0, 0, 0, '', NULL),
-- Fire Training (Horde) Area dependance
(19, 0, 11361, 0, 0, 23, 0, 362,        0,0,0, 0, 0, '', NULL),
(19, 0, 11449, 0, 1, 23, 0, 85,         0,0,0, 0, 0, '', NULL),
(19, 0, 11450, 0, 2, 23, 0, 3665,       0,0,0, 0, 0, '', NULL),
-- For accepting  "Let the fires come" player must have completed at least one of the Fire Brigade Training quests (Alliance)
(19, 0, 12135, 0, 0, 28, 0, 11360,      0,0,0, 0, 0, '', NULL),
(19, 0, 12135, 0, 1, 28, 0, 11439,      0,0,0, 0, 0, '', NULL),
(19, 0, 12135, 0, 2, 28, 0, 11440,      0,0,0, 0, 0, '', NULL),
-- For accepting  Stop the Fires! player must have completed at least one of the Fire Brigade Training quests (Alliance)
(19, 0, 11131, 0, 0, 28, 0, 11360,      0,0,0, 0, 0, '', NULL),
(19, 0, 11131, 0, 1, 28, 0, 11439,      0,0,0, 0, 0, '', NULL),
(19, 0, 11131, 0, 2, 28, 0, 11440,      0,0,0, 0, 0, '', NULL),
-- For accepting  "Let the fires come" player must have completed at least one of the Fire Brigade Training quests (Horde)
(19, 0, 12139, 0, 0, 28, 0, 11361,      0,0,0, 0, 0, '', NULL),
(19, 0, 12139, 0, 1, 28, 0, 11449,      0,0,0, 0, 0, '', NULL),
(19, 0, 12139, 0, 2, 28, 0, 11450,      0,0,0, 0, 0, '', NULL),
-- For accepting  Stop the Fires! player must have completed at least one of the Fire Brigade Training quests (Horde)
(19, 0, 11219, 0, 0, 28, 0, 11361,      0,0,0, 0, 0, '', NULL),
(19, 0, 11219, 0, 0, 28, 0, 11449,      0,0,0, 0, 0, '', NULL),
(19, 0, 11219, 0, 0, 28, 0, 11450,      0,0,0, 0, 0, '', NULL);
...
DELETE FROM `spell_script_names` WHERE `spell_id` IN (24750);
INSERT INTO `spell_script_names` (`spell_id`,`ScriptName`) VALUES
