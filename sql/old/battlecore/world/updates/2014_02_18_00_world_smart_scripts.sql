...
(15,10929,0,0,9,24576,0,0,0,'','Show gossip only if player have A Friendly Chat... H Quest'),
(15,10929,0,1,9,24657,0,0,0,'','Show gossip only if player have A Friendly Chat... A Quest');
