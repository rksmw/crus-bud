...
DELETE FROM `creature` WHERE (`guid` BETWEEN @CGUID+0 AND @CGUID+33) OR (`id` IN (34929, 34935)) OR (`map` IN (641, 642));
...
-- Goblin Engineering Crew
UPDATE `creature_template` SET `minlevel`=80, `maxlevel`=80, `faction_a`=1978 , `faction_h`=1978 WHERE `entry`=36162;

-- 7th Legion Deckhand
UPDATE `creature_template` SET `minlevel`=80, `maxlevel`=80, `faction_a`=1973, `faction_h`=1973 WHERE `entry`=36165;
...
(66899, 628, 747, -1075, 135, 0, 18414);
